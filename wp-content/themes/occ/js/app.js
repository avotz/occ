...
var hoverintent = __webpack_require__(37);
...
hoverintent(navContainer, function () {}, function () {
    $body.toggleClass('nav-is-open');
}).options({
    timeout: 10,
    interval: 50
...
$concierge.forEach(function (element) {
...
hoverintent($menu, function () {
    $(this).find(">.sub-menu").slideDown(200);
}, function () {
    $(this).find(">.sub-menu").slideUp(200);
}).options(opts);

hoverintent($homeMenu, function () {
    $(this).find(">.sub-menu").slideDown(200);
}, function () {
    $(this).find(">.sub-menu").slideUp(200);
}).options(opts);
